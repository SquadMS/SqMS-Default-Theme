                ...
                @foreach ($server->last_query_result->population()->getTeams() as $team)
                    <div class="col-12 col-md">
                        <div class="squad-flag p-md-4 d-flex justify-content-center align-items-center">
                            <div class="ratio ratio-squad-flag data-team-tags flag bg-faction-{{ \SquadMS\Foundation\Helpers\FactionHelper::getFactionTag($team->getId(), $server->last_query_result->layer()) }} bg-cover bg-center" flag-class="bg-faction-{{ \SquadMS\Foundation\Helpers\FactionHelper::getFactionTag($team->getId(), $server->last_query_result->layer()) }}" team-id="{{ $team->getId() }}">
