                        ...
                        <div class="server-inner d-flex flex-column flex-md-row">
                            <div class="main-info d-flex flex-column flex-md-row align-items-md-center flex-md-grow-1 min-width-0">
                                <div class="flex-md-grow-1 min-width-0 d-flex align-items-center p-4">
                                    <span class="w-100 h2 text-truncate text-center text-md-start text-white mb-md-0 data-server-name data-show-online {{ \Illuminate\Support\Arr::get($status, 'online', false) ? '' : 'd-none' }}">{{ \Illuminate\Support\Arr::get($status, 'name', 'Squad Dedicated Server') }}</span>
                                    <span class="w-100 h2 text-truncate text-center text-md-start text-secondary mb-md-0 data-show-offline {{ \Illuminate\Support\Arr::get($status, 'online', false) ? 'd-none' : '' }}">{{ $server->name }}</span>
                                </div>
