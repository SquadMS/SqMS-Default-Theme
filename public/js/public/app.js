...
class Dropdown extends _base_component__WEBPACK_IMPORTED_MODULE_5__.default {
  ...
  show() {
    ...
    if ('ontouchstart' in document.documentElement &&
      ...
      [].concat(...document.body.children)
        .forEach(elem => _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.on(elem, 'mouseover', null, (0,_util_index__WEBPACK_IMPORTED_MODULE_0__.noop)()))
    }
  ...
  static clearMenus(event) {
    ...
    for (let i = 0, len = toggles.length; i < len; i++) {
      const context = _dom_data__WEBPACK_IMPORTED_MODULE_1__.default.get(toggles[i], DATA_KEY)
      const relatedTarget = {
      ...
      const hideEvent = _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.trigger(toggles[i], EVENT_HIDE, relatedTarget)
      if (hideEvent.defaultPrevented) {
        continue
      }
      ...
      if ('ontouchstart' in document.documentElement) {
        [].concat(...document.body.children)
          .forEach(elem => _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.off(elem, 'mouseover', null, (0,_util_index__WEBPACK_IMPORTED_MODULE_0__.noop)()))
      }
      ...
      _dom_manipulator__WEBPACK_IMPORTED_MODULE_3__.default.removeDataAttribute(dropdownMenu, 'popper')
      _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.trigger(toggles[i], EVENT_HIDDEN, relatedTarget)
    }
  }
  ...
  static dataApiKeydownHandler(event) {
    ...
    if (event.key === ESCAPE_KEY) {
      const button = this.matches(SELECTOR_DATA_TOGGLE) ? this : _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__.default.prev(this, SELECTOR_DATA_TOGGLE)[0]
      button.focus()
      Dropdown.clearMenus()
      return
    }
    ...
    const items = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__.default.find(SELECTOR_VISIBLE_ITEMS, parent).filter(_util_index__WEBPACK_IMPORTED_MODULE_0__.isVisible)
...
;(0,_util_index__WEBPACK_IMPORTED_MODULE_0__.defineJQueryPlugin)(NAME, Dropdown)
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksqms_default_theme"] = self["webpackChunksqms_default_theme"] || [];
